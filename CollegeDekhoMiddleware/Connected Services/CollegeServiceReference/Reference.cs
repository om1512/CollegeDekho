...
namespace CollegeDekhoMiddleware.CollegeServiceReference {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="CollegeServiceReference.ICollegeService")]
    public interface ICollegeService {
        ...
        CollegeDekhoMiddleware.CollegeServiceReference.College GetCollegeById(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICollegeService/GetCollegeById", ReplyAction="http://tempuri.org/ICollegeService/GetCollegeByIdResponse")]
        System.Threading.Tasks.Task<CollegeDekhoMiddleware.CollegeServiceReference.College> GetCollegeByIdAsync(int id);
        ...
        CollegeDekhoMiddleware.CollegeServiceReference.College GetCollegeByName(string name);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICollegeService/GetCollegeByName", ReplyAction="http://tempuri.org/ICollegeService/GetCollegeByNameResponse")]
        System.Threading.Tasks.Task<CollegeDekhoMiddleware.CollegeServiceReference.College> GetCollegeByNameAsync(string name);
        ...
        CollegeDekhoMiddleware.CollegeServiceReference.College GetCollegeByPlace(string place);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICollegeService/GetCollegeByPlace", ReplyAction="http://tempuri.org/ICollegeService/GetCollegeByPlaceResponse")]
        System.Threading.Tasks.Task<CollegeDekhoMiddleware.CollegeServiceReference.College> GetCollegeByPlaceAsync(string place);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ICollegeServiceChannel : CollegeDekhoMiddleware.CollegeServiceReference.ICollegeService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class CollegeServiceClient : System.ServiceModel.ClientBase<CollegeDekhoMiddleware.CollegeServiceReference.ICollegeService>, CollegeDekhoMiddleware.CollegeServiceReference.ICollegeService {
        ...
        public CollegeDekhoMiddleware.CollegeServiceReference.College GetCollegeById(int id) {
            return base.Channel.GetCollegeById(id);
        }
        
        public System.Threading.Tasks.Task<CollegeDekhoMiddleware.CollegeServiceReference.College> GetCollegeByIdAsync(int id) {
            return base.Channel.GetCollegeByIdAsync(id);
        }
        
        public CollegeDekhoMiddleware.CollegeServiceReference.College GetCollegeByName(string name) {
            return base.Channel.GetCollegeByName(name);
        }
        
        public System.Threading.Tasks.Task<CollegeDekhoMiddleware.CollegeServiceReference.College> GetCollegeByNameAsync(string name) {
            return base.Channel.GetCollegeByNameAsync(name);
        }
        
        public CollegeDekhoMiddleware.CollegeServiceReference.College GetCollegeByPlace(string place) {
            return base.Channel.GetCollegeByPlace(place);
        }
        
        public System.Threading.Tasks.Task<CollegeDekhoMiddleware.CollegeServiceReference.College> GetCollegeByPlaceAsync(string place) {
